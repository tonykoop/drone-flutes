# F#m drone flute — inlay artwork

Inlay files are sized to fit ONE facet of the F#m flute. Eight identical bands wrap around the body (one per facet); the feature panel goes on a single chosen facet.

## Per-facet dimensions (this key)

| Item | Value |
|------|-------|
| facet_side_length | 0.549 in |
| facet_inset | 0.100 in (each side) |
| inlay_band_width | 0.349 in |
| band_height | 0.500 in |
| feature_panel_width | 0.349 in |
| feature_panel_height | 7.996 in |
| L_total (full flute) | 24.987 in |
