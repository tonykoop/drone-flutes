# Em drone flute — inlay artwork

Inlay files are sized to fit ONE facet of the Em flute. Eight identical bands wrap around the body (one per facet); the feature panel goes on a single chosen facet.

## Per-facet dimensions (this key)

| Item | Value |
|------|-------|
| facet_side_length | 0.601 in |
| facet_inset | 0.100 in (each side) |
| inlay_band_width | 0.401 in |
| band_height | 0.500 in |
| feature_panel_width | 0.401 in |
| feature_panel_height | 8.712 in |
| L_total (full flute) | 27.225 in |
